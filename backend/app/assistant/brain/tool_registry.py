...
TOOL_REGISTRY: Dict[str, ToolDefinition] = {
    ...
    "music_play": ToolDefinition(
        name="music_play",
        description="Search and play a song directly in the Zana player via official SoundCloud audio playback provider.",
        permission_id="music.play",
        risk_level=RiskLevel.LOW,
        required_args=["query"],
    ...
    "soundcloud_search": ToolDefinition(
        name="soundcloud_search",
        description="Search SoundCloud for playable tracks with deterministic ranking.",
        permission_id="music.search",
        risk_level=RiskLevel.LOW,
        required_args=["query"],
        optional_args=["artist", "limit", "access"],
        input_schema={"query": "string", "artist": "string", "limit": "integer", "access": "string"},
