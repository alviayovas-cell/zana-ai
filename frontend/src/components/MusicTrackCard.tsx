  ...
  return (
    <div className={`music-track-card provider-${provider}`} role="region" aria-label={`Music Result: ${track.title}`}>
      ...
      <div className="card-body-row">
        {artUrl ? (
          <img src={artUrl} alt={track.title} className="card-thumbnail" loading="lazy" />
        ) : (
        ...
        <div className="card-meta">
          ...
          <span className="card-artist" title={channelOrArtist}>{channelOrArtist}</span>
        </div>
      </div>
      ...
      <div className="card-actions-row">
        ...
        {provider === 'soundcloud' && (
          <button className="btn-card-action btn-disabled-action" disabled>
